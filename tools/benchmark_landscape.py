...
def history_panel(catalog):
    ...
    return ('<section id="benchmark-explorer"><h2>Comparison landscape history</h2>'
            ...
            '<label>Version: <input data-control="version" type="range" min="0" max="0" step="1" value="0"></label>'
            ...
            '<button type="button" data-reset>Reset view</button><div data-chart></div></details>'
