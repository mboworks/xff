...
constexpr std::array kGlobals = std::to_array<GlobalFlag>({
    ...
    },
    {
        ...
        .details = "With `--compare`, bare `--summary` or `--summary=compare` appends result counts, combined "
                   ...
                   "scopes and fixed summary columns. Each accounting note stays with its table, separated from "
                   "the next summary by a blank line. Exact bytes align with scaled sizes at the decimal boundary. "
