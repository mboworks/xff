...
TEST_F(TextWidthTest, CountsColumnsRatherThanUtf8Bytes) {
  ...
  EXPECT_THAT(TextColumns("\u754c\u9762"), Eq(4));
...
TEST_F(TextWidthTest, WrapsWithoutSplittingCombiningOrJoinedGraphemes) {
  EXPECT_THAT(WrapColumns("cafe\u0301z", 4), ElementsAre("cafe\u0301", "z"));
  EXPECT_THAT(WrapColumns("\u754c\u9762x", 3), ElementsAre("\u754c", "\u9762x"));
  EXPECT_THAT(WrapColumns("\U0001f469\u200d\U0001f4bbx", 2), ElementsAre("\U0001f469\u200d\U0001f4bb", "x"));
  EXPECT_THAT(WrapColumns("\u754cx", 1), ElementsAre("\u754c", "x"));
