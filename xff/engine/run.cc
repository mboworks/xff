...
struct SummaryAccumulator {
  ...
  std::map<std::string, std::map<std::string, SummaryTables>> partitions;
...
std::vector<SummaryRow> SummaryRows(SummaryMode mode, const SummaryCells& cells, std::optional<std::size_t> top) {
